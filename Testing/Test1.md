...
- **Mitigation:** Raising either the ladder presets above 20 ms eliminates the observed glitch in repeated trials. This likely provides enough margin for the connection object to service each production trigger without overruns.
