...
const char *webui_get_index_html(void)
{
    return "<!DOCTYPE html>"
           ...
           "<body>"
           "<div class=\"container\">"
           "<h1>VL53L1x Sensor Configuration <span class=\"badge bg-secondary\">Beta 1.1</span></h1>"
           "<form id=\"configForm\">"
           "<div class=\"row\">"
           "<div class=\"col-md-6\">"
...
const char *webui_get_status_html(void)
{
    return "<!DOCTYPE html>"
           ...
           "<body>"
           "<div class=\"container\">"
           "<h1>VL53L1x Sensor Status <span class=\"badge bg-secondary\">Beta 1.1</span></h1>"
...
const char *webui_get_ota_html(void)
{
    return "<!DOCTYPE html>"
           ...
           "<body>"
           "<div class=\"container\">"
           "<h1>OTA Firmware Update <span class=\"badge bg-secondary\">Beta 1.1</span></h1>"
           "<div class=\"form-group\">"
